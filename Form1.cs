...
//               MessageBox.Show(dr["PROD_STA"].ToString());
        ...
        private void prod_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter adapt2 = new MySqlDataAdapter("SELECT * FROM PROD_STAT WHERE PROD_STA = 'N'", con);
            ...
            double res = (double)a / (double)num;// * 100.0;
            All.Text = "총 생산량 : ";
            All.Text += num.ToString();
            All.Text += "\n";
            All.Text += "불량 생산량 : ";
            All.Text += a.ToString();
            All.Text += "\n불량 률 : ";
            All.Text += res.ToString("P2") ;
